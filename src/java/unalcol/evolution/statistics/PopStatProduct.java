...
import unalcol.*;
import unalcol.abs.Product;


/**
 * <p>Title: PopStatProduct</p>
...
public class PopStatProduct extends Product<PopulationStatistics> {
    /**
     * Adds to the second PopStat the first PopStat. The Product process is component by component
     ...
     */
    public PopulationStatistics fastMultiply(PopulationStatistics x, PopulationStatistics y) {
        x.best *= y.best;
        x.avg *= y.avg;
        x.worst *= y.worst;
     ...
     */
    public PopulationStatistics fastDivide(PopulationStatistics x, PopulationStatistics y) {
        x.best /= y.best;
        x.avg /= y.avg;
        x.worst /= y.worst;
        x.avg_length /= y.avg_length;
