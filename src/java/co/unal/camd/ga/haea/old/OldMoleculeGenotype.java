...
public class OldMoleculeGenotype extends Genotype<Molecule> {
    protected int maxNumGroups;
    protected ContributionParametersManager parametersManager;

    public OldMoleculeGenotype(int _maxNmGroups, ContributionParametersManager _aGC) {
     ...
     */
    public Molecule newInstance() {
        Molecule aGenotype = new Molecule();
        int dim = 0;
        int refCode = 0;
     ...
     */
    public int size(Molecule genome) {
...
//	/	System.out.println("pruebaa2");
    ...
    public Molecule addGroupToMolec(ArrayList<FunctionalGroupNode> leaves, int dim) {
