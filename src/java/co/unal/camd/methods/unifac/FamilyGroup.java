...
public class FamilyGroup {
     ...
     */
    private List<UnifacMainGroup> mainGroups = new ArrayList<>();
    ...
    public String toString() {
        List<Integer> groups = mainGroups.stream().map(UnifacMainGroup::getCode).collect(Collectors.toList());
