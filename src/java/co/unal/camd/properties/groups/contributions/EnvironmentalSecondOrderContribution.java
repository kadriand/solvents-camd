...
public class EnvironmentalSecondOrderContribution {
    ...
    public String toString() {
        return String.format(Locale.ROOT, "Group contributions of [%d] %s : waterLC50FM : %f , waterLC50DM : %f , ratLD50 : %f , waterLogWS : %f , waterBFC : %f , airERAc : %f , airERAnc : %f , airEUAc : %f , airEUAnc : %f",
