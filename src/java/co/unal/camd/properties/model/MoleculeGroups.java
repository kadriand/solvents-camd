...
public class MoleculeGroups {
    ...
    private int[] amount;
    private int[] groups;
    private ContributionGroup[] groupContributions;
    ...
    private void findGroupContributions() {
        groupContributions = new ContributionGroup[groups.length];
        for (int i = 0; i < groups.length; i++) {
            ContributionGroup groupContribution = CamdRunner.CONTRIBUTION_GROUPS.getThermoPhysicalFirstOrderContributions().get(groups[i]);
